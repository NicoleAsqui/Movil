"""
Django settings for FrontMovil project.
...
SECRET_KEY = 'django-insecure-3pkotmq@60cbd5aj%uqd%p)5wie+zvxr$!v=x!2&shc!%4aarx'
...
WSGI_APPLICATION = 'FrontMovil.wsgi.application'
